...
public class BajaProveedores  extends Frame implements WindowListener, ActionListener
{
	...
	BajaProveedores()	
	{
		...
		// Montar el Choice
		choProveedor.add("Seleccionar uno...");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(objetoPulsado.equals(btnSi))
		{
			...
			Connection con = conectar(); 
			// Borrar
			String[] Proveedor=choProveedor.getSelectedItem().split("-");
